...
from tradeyuk.agents.managers.research_manager import create_research_manager
from tradeyuk.agents.trader.trader import create_trader
from tradeyuk.graph.signal_processing import SignalProcessor
